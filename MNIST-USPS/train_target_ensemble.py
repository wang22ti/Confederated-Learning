...
if __name__ == '__main__':
    ...
    log_file = open('log/{}_{}_ensemble.log'.format(target_name, noise_rate), 'a')
    for alpha in [0.95, 0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6, 0.55, 0.5]:
        init(0)

        # prepare data
        print('ensemble, target:', target_name, 'noise rate:', noise_rate, 'alpha:', alpha, file=log_file)
